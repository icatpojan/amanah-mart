...
<body>
    <div class="container">
        ...
        <form id="ajaxform">
            ...
            <div class="form-group">
                <label>Jumlah:</label>
                <input type="email" name="jumlah" class="form-control" placeholder="jumlah" required="">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="jumlah_harga" class="form-control" placeholder="jumlah harga" required="">
            </div>
            <div class="form-group">
